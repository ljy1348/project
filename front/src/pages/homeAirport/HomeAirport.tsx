...
function HomeAirport({ setShow, set공항 }: { setShow: any; set공항: any }) {
  const initAirport = {
    cname: "",
    abbr: "",
  };
  ...
  return (
    <div className="homeTotalDiv">
      <div className="home_select_airport">
          <div className="home_list_nation">
            <ul>
              <li
                className={
                  "home_international_list " +
          ...
          <div className="">
            <div className="home_international_listbox" ref={listBox}>
              <ul className="home_city_list">
